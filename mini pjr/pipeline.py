...
# Main pipeline
# ------------------------------
def process_whiteboard(image_path: str, out_pdf: str, tesseract_cmd: Optional[str] = None) -> str:
...
def upload_file():
    ...
    pdf_path = process_whiteboard(file_path, out_pdf, tesseract_cmd=tesseract_path)
